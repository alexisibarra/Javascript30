...
switch (body.classList[0]){
  ...
  case "arraycardio2":
    ...
    const olderSome19 = people2.some((person) => today.getFullYear() - person.year >= 19);

    console.log(olderSome19);

    // Array.prototype.every() // is everyone 19 or older?
    const olderEvery19 = people2.every((person) => today.getFullYear() - person.year >= 19);

    console.log(olderEvery19);
    ...
    console.table([... comments.slice(0, findIndex), ... comments.slice(findIndex+1)]);
